...
export const createPayment = async (req, res) => {
    try {
        const { groupId, payer, payee, amount, paymentMethod, transactionId, currency } = req.body;
...
export const getPaymentById = async (req, res) => {
    try {
        const payment = await Payment.findById(req.params.paymentId).populate("payer payee groupId");
        if (!payment) {
